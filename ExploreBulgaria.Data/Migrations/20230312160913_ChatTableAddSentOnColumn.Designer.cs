...
namespace ExploreBulgaria.Data.Migrations
{
    ...
    [Migration("20230312160913_ChatTableAddSentOnColumn")]
    partial class ChatTableAddSentOnColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FromVisitorId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ToVisitorId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("FromVisitorId");

                    b.HasIndex("IsDeleted");

                    b.HasIndex("ToVisitorId");
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.VisitorFavoriteAttraction", b =>
                {
                    ...
                    b.HasKey("VisitorId", "AttractionId");
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.Attraction", b =>
                {
                    ...
                    b.HasOne("ExploreBulgaria.Data.Models.Village", "Village")
                        .WithMany("Attractions")
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.Chat", b =>
                {
                    b.HasOne("ExploreBulgaria.Data.Models.Visitor", "FromVisitor")
                        .WithMany()
                        .HasForeignKey("FromVisitorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ExploreBulgaria.Data.Models.Visitor", "ToVisitor")
                        .WithMany()
                        .HasForeignKey("ToVisitorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FromVisitor");

                    b.Navigation("ToVisitor");
                });
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.VisitorFavoriteAttraction", b =>
                {
                    b.HasOne("ExploreBulgaria.Data.Models.Attraction", "Attraction")
                        .WithMany("AddedToFavoritesByVisitors")
                        .HasForeignKey("AttractionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExploreBulgaria.Data.Models.Attraction", b =>
                {
                    b.Navigation("AddedToFavoritesByVisitors");

                    b.Navigation("Comments");

                    b.Navigation("Images");

                    b.Navigation("VisitedByVisitors");
