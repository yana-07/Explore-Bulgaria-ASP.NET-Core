namespace ExploreBulgaria.Services.Constants
{
    public static class MessageConstants
    {
        ...
        public const string CategorySuccessfullyAdded = "Категорията беше добавена успешно.";

        public const string SubcategorySuccessfullyAdded = "Подкатегорията беше добавена успешно.";
